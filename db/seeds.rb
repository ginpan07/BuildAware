...
StudentActivity.create(student_id: Student.first, activity_id: Activity.first)
StudentActivity.create(student_id: Student.second, activity_id: Activity.second)
StudentActivity.create(student_id: Student.third, activity_id: Activity.third)
StudentActivity.create(student_id: Student.fourth, activity_id: Activity.fourth)
StudentActivity.create(student_id: Student.fifth, activity_id: Activity.fifth)
